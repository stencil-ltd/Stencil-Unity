...
{
    [Serializable]
    public struct UInt128 : IFormattable, IComparable, IComparable<UInt128>, IEquatable<UInt128>, ISerializable
    {
        ...
        {
             var str = info.GetString("uint128");
             TryParse(str, out this);
        }

        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            info.AddValue("uint128", ToString());
        }
    }
}
