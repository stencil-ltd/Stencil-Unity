...
{
    public struct NetworkBroadcastResult : IComparable<NetworkBroadcastResult>
    {
        public string serverAddress;
        public byte[] broadcastData;
        public DateTime seen;

        public bool Equals(NetworkBroadcastResult other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is NetworkBroadcastResult && Equals((NetworkBroadcastResult) obj);
        }

        public override int GetHashCode()
        {
            return (serverAddress != null ? serverAddress.GetHashCode() : 0);
        }

        public int CompareTo(NetworkBroadcastResult other)
        {
            return seen.CompareTo(other.seen);
        }
    }
